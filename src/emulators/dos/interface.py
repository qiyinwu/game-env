    ...
    async def step(self, 
        ...
        try:
            ...
            action_map = {
                ...
                'move_mouse_left': lambda *args: self.browser.move_mouse_left(),
                'move_mouse_right': lambda *args: self.browser.move_mouse_right(), 
                'move_mouse_up': lambda *args: self.browser.move_mouse_up(),
                'move_mouse_down': lambda *args: self.browser.move_mouse_down(),
                'drag': self.drag,
